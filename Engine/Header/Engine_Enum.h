...
namespace Engine
{
	...
	enum ITEMTYPE	{ ITEM_WEAPON, ITEM_POTION, ITEM_KEY, ITEM_IMG, ITEM_END };
	...
	enum MONSTER { M_GREENSLIME, M_PICKSLIME, M_FIST, M_BLUEBAT, M_STICK, M_LEAF, M_SKELETONGHOST, M_SONGBOSS, MONSTER_END };
