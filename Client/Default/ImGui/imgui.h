...
#define IMGUI_PAYLOAD_TYPEtColor_3F     "_COL3F"    // float[3]: Standard type for colors, without alpha. User code may use this type.
#define IMGUI_PAYLOAD_TYPEtColor_4F     "_COL4F"    // float[4]: Standard type for colors. User code may use this type.
