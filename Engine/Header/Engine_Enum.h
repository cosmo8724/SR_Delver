...
namespace Engine
{
	...
	enum ITEMTYPE	{ ITEM_WEAPON, ITEM_POTION, ITEM_KEY, ITEM_FOOD,
					...
					ITEM_FIRE, ITEM_SHIELD, ITEM_IMG, ITEM_END };
	...
	enum ECOOBJTYPE { ECO_STONE, ECO_GRASS, ECO_TREE, ECO_JAR, ECO_JAM, ECO_LADDER, ECO_BONFIRE,
				ECO_WEB, ECO_MUSHROOM, ECO_DOOR, ECO_STATUE, ECO_TORCH1, ECO_TORCH2, ECO_END };
